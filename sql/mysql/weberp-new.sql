...
--
-- Host: localhost    Database: sicomm
-- ------------------------------------------------------
...
--
-- Current Database: `sicomm`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sicomm` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `stockmoves` (
  ...
  `pono` int(11) NOT NULL DEFAULT '0', 
  `wono` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `woitems` (
  ...
  `qtyrecd` double NOT NULL DEFAULT '0',
  `maincomppo` int(11) NOT NULL DEFAULT '0',
  `maincomprecv` date NOT NULL DEFAULT '0000-00-00',
...
CREATE TABLE `workorders` (
  ...
  `keyqtyissued` double NOT NULL DEFAULT '0',
...
INSERT INTO `companies` VALUES (1,'webERP\'s Demo Company Inc','not entered yet','','123 Web Way','PO Box 123','Queen Street','Melbourne','Victoria 3043','Australia','+61 3 4567 8901','+61 3 4567 8902','weberp@sicomm.com','AUD',1100,4900,2100,2400,2150,4200,5200,3500,1,1,1,5600);
...
INSERT INTO `config` VALUES ('part_pics_dir','companies/sicomm/part_pics');
...
INSERT INTO `config` VALUES ('reports_dir','companies/sicomm/reportwriter');
