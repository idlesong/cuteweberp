...
if (count($_SESSION['PO']->LineItems)>=0){
   ...
   foreach ($_SESSION['PO']->LineItems as $POLine) {
    ...
    echo '<tr><td><input type=submit name="EnterLine" value="' . _('Enter Line') . '"></td> <td colspan=6 align=right>' . _('TOTAL Excl Tax') . '</td><td align=right><b>' . $DisplayTotal . '</b></td></tr></table>';
