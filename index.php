...
//echo '<script>window.location ="' . $rootpath . '/CustomerInquiry.php?"</script>';
...
<?php
	...
	//echo 'Access:'.$_SESSION['AllowedPageSecurityTokens'];
	if (in_array(15, $_SESSION['AllowedPageSecurityTokens'])){//Admin
		$_SESSION['Module'] = 'system';
	}else if( in_array(11, $_SESSION['AllowedPageSecurityTokens']) ){//Manuf
		echo '<script>window.location ="' . $rootpath . '/A_ManufHome.php?"</script>';
	}else if( in_array(10, $_SESSION['AllowedPageSecurityTokens']) ){//Accountant
		echo '<script>window.location ="' . $rootpath . '/CustomerAllocations.php?"</script>';
	}else if( in_array(3, $_SESSION['AllowedPageSecurityTokens']) ){ //Sales
		echo '<script>window.location ="' . $rootpath . '/A_SalesHome.php?"</script>';
	}else{
	}
				...
				<table width="100%" >
					...
					<td class="menu_group_items"> <!-- Orders Maintenance options -->
						<table width="100%">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/SelectCompletedCustOrder.php?' . SID . "'><LI>" . _('Customer Order Inquiry') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/SelectCompletedOrder.php?' . SID . "'><LI>" . _('Sales Order Inquiry') . '</LI></A>'; ?>
							</td>
							</tr>							
							  <td>
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/PO_Header.php?&NewOrder=Yes' . SID . "'><LI>" . _('Wafer PO Entry(NEW)') . '</LI></A>'; ?>
							</td>
							</tr>							
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/PO_SelectOSPurchOrder.php?' . SID . "'><LI>" . _('Wafer PO Inquiry') . '</LI></A>'; ?>
							</td>
							</tr>					
							<tr>
							  <td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/WorkOrderEntry.php?' . SID . "'><LI>" . _('Packing PO Entry(NEW)') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/SelectWorkOrder.php?' . SID . "'><LI>" . _('Packing PO Inquiry') . '</LI></A>'; ?>
							</td>
							</tr>	
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/StockMovementsFlow.php?' . SID . "'><LI>" . _('Product Management(Sicomm)') . '</LI></A>'; ?>
							</td>
							</tr>							
						</table>
					</td>
