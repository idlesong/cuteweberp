...
echo '<P CLASS="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/supplier.png" TITLE="' . _('Search') . '" ALT="">' . ' ' . _('Suppliers:Home') . '';
echo '<HR>';
}
...
<TR>
<TD><INPUT TYPE=SUBMIT NAME='Search' VALUE='" . _('Search Now') . "'></TD>
</TR>
</TABLE>
";

echo "<BR><input onclick=\"javascript:window.location.href='Suppliers.php?'\"  type='button' value='Add New Supplier' />";	
echo "<input onclick=\"javascript:window.location.href='WorkCentres.php?'\"  type='button' value='All Work Centers' />";	
...
if (isset($_POST['Search'])) {
	...
	while (($myrow=DB_fetch_array($result)) AND ($RowIndex <> $_SESSION['DisplayRecordsMax'])) {
		...
		printf("<tr>
			<td><INPUT onclick=\"javascript:window.location.href='Suppliers.php?&SupplierID=%s'\" TYPE=button VALUE='%s'</td>
			<td>%s</td>
			<td>%s</td>
			<td>%s</td>
			<td>%s</td>
